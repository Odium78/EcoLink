...
function MobileSDGList() {
    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen snap-center" id="sdglist">
            <h1 className="text-lg font-bold text-shadow-md text-shadow-violet-400">Definition and Connectedness of each SDG</h1>
            <Carousel>
            ...
            <div className="flex flex-col text-center">
                ...
                <p className="text-xs text-center font-semibold">Above are concise definitions and how these Sustainable <br />Development Goals (SDGs) interrelate</p>
            </div>
